...
#[test]
fn opt2_single_auth_single_multi_attr_ok() {
...
#[test]
fn opt2_single_auth_single_fail() {
    let user_attrs = vec![];
    let policy = "A.a:0";
...
#[test]
fn opt2_single_auth_conjunction_ok() {
...
#[test]
fn opt2_single_auth_conjunction_no_left_fail() {
...
#[test]
fn opt2_single_auth_conjunction_no_right_fail() {
    let user_attrs = vec!["A.a:0"];
    let policy = "A.a:0 & A.b:0";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_single_auth_negation_ok() {
    let user_attrs = vec!["A.a:0"];
    let policy = "!A.a:1";
    assert_decryption_ok(user_attrs, policy);
}
...
#[test]
fn opt2_single_auth_negation_multi_alternative_ok() {
...
#[test]
fn opt2_single_auth_negation_contradiction_fail() {
...
#[test]
fn opt2_single_auth_negation_no_alternative_fail() {
    let user_attrs = vec!["A.b:0"];
    let policy = "!A.a:1";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_single_auth_disjunction_left_ok() {
    let user_attrs = vec!["A.a:0"];
...
#[test]
fn opt2_single_auth_disjunction_right_ok() {
    let user_attrs = vec!["A.a:1"];
    let policy = "A.a:0 | A.a:1";
    assert_decryption_ok(user_attrs, policy);
}
...
#[test]
fn opt2_single_auth_disjunction_both_ok() {
...
#[test]
fn opt2_single_auth_disjunction_fail() {
    let user_attrs = vec![];
    let policy = "A.a:0 | A.b:0";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_single_auth_conjunction_left_negated_ok() {
...
#[test]
fn opt2_single_auth_conjunction_left_negated_contradiction_fail() {
    let user_attrs = vec!["A.a:0", "A.b:0"];
    let policy = "!A.a:0 & A.b:0";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_single_auth_conjunction_left_negated_no_alternative_fail() {
    let user_attrs = vec!["A.b:0"];
    let policy = "!A.a:0 & A.b:0";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_single_auth_conjunction_left_negated_no_right_fail() {
...
#[test]
fn opt2_single_auth_conjunction_both_negated_ok() {
...
#[test]
fn opt2_single_auth_disjunction_right_negated_ok() {
...
#[test]
fn opt2_single_auth_disjunction_right_negated_both_ok() {
    let user_attrs = vec!["A.a:1", "A.b:0"];
    let policy = "A.a:1 | !A.b:0";
    assert_decryption_ok(user_attrs, policy);
}
...
#[test]
fn opt2_single_auth_disjunction_right_negated_contradiction_fail() {
    let user_attrs = vec!["A.b:0"];
    let policy = "A.a:1 | !A.b:0";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_single_auth_disjunction_right_negated_no_alternative_fail() {
    let user_attrs = vec![];
    let policy = "A.a:1 | !A.b:0";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_single_auth_disjunction_both_negated_ok() {
    let user_attrs = vec!["A.a:1", "A.b:0"];
    let policy = "!A.a:0 | !A.b:0";
    assert_decryption_ok(user_attrs, policy);
}
...
#[test]
fn opt2_single_auth_complex_1_ok() {
...
#[test]
fn opt2_single_auth_complex_2_ok() {
...
#[test]
fn opt2_single_auth_complex_fail() {
...
#[test]
fn opt2_multi_auth_disjunction_left_ok() {
    let user_attrs = vec!["A.a:0"];
...
#[test]
fn opt2_multi_auth_disjunction_right_ok() {
...
#[test]
fn opt2_multi_auth_disjunction_both_ok() {
...
#[test]
fn opt2_multi_auth_disjunction_wrong_auth_fail() {
...
#[test]
fn opt2_multi_auth_conjunction_ok() {
    let user_attrs = vec!["A.a:0", "B.a:0"];
    let policy = "A.a:0 & B.a:0";
    assert_decryption_ok(user_attrs, policy);
}
...
#[test]
fn opt2_multi_auth_conjunction_missing_left_fail() {
    let user_attrs = vec!["B.a:0"];
    let policy = "A.a:0 & B.a:0";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_multi_auth_conjunction_missing_right_fail() {
    let user_attrs = vec!["A.a:0"];
    let policy = "A.a:0 & B.a:0";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_multi_auth_negation_ok() {
...
#[test]
fn opt2_multi_auth_negation_cross_auth_fail() {
    let user_attrs = vec!["B.a:0"];
    let policy = "!A.a:0";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_multi_auth_complex_1_ok() {
...
#[test]
fn opt2_multi_auth_complex_2_ok() {
...
#[test]
fn opt2_multi_auth_complex_fail() {
