...
fn test_scheme(user_attrs: Vec<&str>, policy: &str) -> (curve::Gt, Option<curve::Gt>) {
    use abe_cubed::scheme::{Iota, Opt2, Scheme, Tau};
...
#[test]
fn opt2_generated_test_case_000_ok() {
...
#[test]
fn opt2_generated_test_case_000_fail() {
    let user_attrs = vec![];
    let policy = "(B.a:0 | C.a:6)";
...
#[test]
fn opt2_generated_test_case_001_ok() {
...
#[test]
fn opt2_generated_test_case_001_fail() {
    let user_attrs = vec![];
    let policy = "(D.c:1 | (A.e:5 & B.b:2))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_002_ok() {
...
#[test]
fn opt2_generated_test_case_002_fail() {
    let user_attrs = vec![];
    let policy = "(A.e:6 | D.e:0)";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_003_ok() {
...
#[test]
fn opt2_generated_test_case_003_fail() {
    let user_attrs = vec![];
    let policy = "B.a:3";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_004_ok() {
...
#[test]
fn opt2_generated_test_case_004_fail() {
...
#[test]
fn opt2_generated_test_case_005_ok() {
...
#[test]
fn opt2_generated_test_case_005_fail() {
    let user_attrs = vec![];
    let policy = "(B.d:0 | D.a:6)";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_006_ok() {
...
#[test]
fn opt2_generated_test_case_006_fail() {
    let user_attrs = vec![];
    let policy = "(C.a:5 | ((!A.c:2 & C.a:0) & (D.b:0 | (C.a:0 | ((C.b:0 & B.a:1) & A.c:1)))))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_007_ok() {
...
#[test]
fn opt2_generated_test_case_007_fail() {
    let user_attrs = vec![];
    let policy = "(B.c:0 | ((C.a:6 | A.d:2) | (B.d:6 & B.a:2)))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_008_ok() {
...
#[test]
fn opt2_generated_test_case_008_fail() {
    let user_attrs = vec![];
    let policy = "((!C.a:3 | (!D.b:2 & ((D.e:6 | (A.e:6 & (D.a:1 | (B.a:4 | A.d:4)))) & D.e:1))) | (D.c:1 | A.c:2))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_009_ok() {
...
#[test]
fn opt2_generated_test_case_009_fail() {
...
#[test]
fn opt2_generated_test_case_010_ok() {
...
#[test]
fn opt2_generated_test_case_010_fail() {
    let user_attrs = vec![];
    let policy = "!D.b:5";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_011_ok() {
...
#[test]
fn opt2_generated_test_case_011_fail() {
...
#[test]
fn opt2_generated_test_case_012_ok() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_012_fail() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_013_ok() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_013_fail() {
...
#[test]
fn opt2_generated_test_case_014_ok() {
...
#[test]
fn opt2_generated_test_case_014_fail() {
    let user_attrs = vec![];
    let policy = "(D.b:6 | ((((A.b:1 | D.c:6) | B.b:6) | B.a:1) & D.d:2))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_015_ok() {
...
#[test]
fn opt2_generated_test_case_015_fail() {
...
#[test]
fn opt2_generated_test_case_016_ok() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_016_fail() {
...
#[test]
fn opt2_generated_test_case_017_ok() {
...
#[test]
fn opt2_generated_test_case_017_fail() {
    let user_attrs = vec![];
    let policy = "(C.b:0 | (D.c:5 | D.e:6))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_018_ok() {
...
#[test]
fn opt2_generated_test_case_018_fail() {
    let user_attrs = vec![];
    let policy = "!B.d:3";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_019_ok() {
...
#[test]
fn opt2_generated_test_case_019_fail() {
...
#[test]
fn opt2_generated_test_case_020_ok() {
...
#[test]
fn opt2_generated_test_case_020_fail() {
    let user_attrs = vec![];
    let policy = "B.a:0";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_021_ok() {
...
#[test]
fn opt2_generated_test_case_021_fail() {
    let user_attrs = vec![];
    let policy = "((B.b:6 | !A.a:0) | (B.a:0 & B.e:4))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_022_ok() {
...
#[test]
fn opt2_generated_test_case_022_fail() {
    let user_attrs = vec![];
    let policy = "C.d:4";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_023_ok() {
...
#[test]
fn opt2_generated_test_case_023_fail() {
...
#[test]
fn opt2_generated_test_case_024_ok() {
...
#[test]
fn opt2_generated_test_case_024_fail() {
    let user_attrs = vec![];
    let policy = "(B.e:6 | D.b:0)";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_025_ok() {
...
#[test]
fn opt2_generated_test_case_025_fail() {
...
#[test]
fn opt2_generated_test_case_026_ok() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_026_fail() {
...
#[test]
fn opt2_generated_test_case_027_ok() {
...
#[test]
fn opt2_generated_test_case_027_fail() {
...
#[test]
fn opt2_generated_test_case_028_ok() {
...
#[test]
fn opt2_generated_test_case_028_fail() {
    let user_attrs = vec![];
    let policy = "((A.d:1 & (B.e:6 & A.d:5)) | D.c:5)";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_029_ok() {
...
#[test]
fn opt2_generated_test_case_029_fail() {
    let user_attrs = vec![];
    let policy = "C.e:6";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_030_ok() {
...
#[test]
fn opt2_generated_test_case_030_fail() {
    let user_attrs = vec![];
    let policy = "(((B.e:4 | D.c:3) & !A.a:0) | ((B.b:2 & (A.d:2 | A.d:0)) & A.c:6))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_031_ok() {
...
#[test]
fn opt2_generated_test_case_031_fail() {
    let user_attrs = vec![];
    let policy = "A.a:4";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_032_ok() {
...
#[test]
fn opt2_generated_test_case_032_fail() {
    let user_attrs = vec![];
    let policy = "(((A.b:4 | (C.c:6 | (C.b:3 | B.c:4))) & B.e:4) | (A.c:5 | !C.e:0))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_033_ok() {
...
#[test]
fn opt2_generated_test_case_033_fail() {
...
#[test]
fn opt2_generated_test_case_034_ok() {
...
#[test]
fn opt2_generated_test_case_034_fail() {
...
#[test]
fn opt2_generated_test_case_035_ok() {
...
#[test]
fn opt2_generated_test_case_035_fail() {
    let user_attrs = vec![];
    let policy = "!A.d:2";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_036_ok() {
...
#[test]
fn opt2_generated_test_case_036_fail() {
...
#[test]
fn opt2_generated_test_case_037_ok() {
...
#[test]
fn opt2_generated_test_case_037_fail() {
    let user_attrs = vec![];
    let policy = "((!D.c:1 | D.c:2) | A.e:3)";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_038_ok() {
...
#[test]
fn opt2_generated_test_case_038_fail() {
    let user_attrs = vec![];
    let policy = "!D.c:4";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_039_ok() {
...
#[test]
fn opt2_generated_test_case_039_fail() {
...
#[test]
fn opt2_generated_test_case_040_ok() {
...
#[test]
fn opt2_generated_test_case_040_fail() {
...
#[test]
fn opt2_generated_test_case_041_ok() {
...
#[test]
fn opt2_generated_test_case_041_fail() {
    let user_attrs = vec![];
    let policy = "(((B.b:5 & A.b:5) & ((B.c:0 | B.a:1) | C.a:1)) | D.e:1)";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_042_ok() {
    let user_attrs = vec!["A.b:6"];
...
#[test]
fn opt2_generated_test_case_042_fail() {
    let user_attrs = vec![];
    let policy = "(A.b:6 | (A.b:3 & ((((D.e:4 & B.e:4) | A.b:4) & !D.e:5) & C.b:1)))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_043_ok() {
...
#[test]
fn opt2_generated_test_case_043_fail() {
...
#[test]
fn opt2_generated_test_case_044_ok() {
...
#[test]
fn opt2_generated_test_case_044_fail() {
...
#[test]
fn opt2_generated_test_case_045_ok() {
...
#[test]
fn opt2_generated_test_case_045_fail() {
    let user_attrs = vec![];
    let policy = "(((!C.e:6 | (!B.e:2 & (B.c:3 & D.e:6))) | (A.b:0 | B.b:4)) | C.c:4)";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_046_ok() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_046_fail() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_047_ok() {
...
#[test]
fn opt2_generated_test_case_047_fail() {
...
#[test]
fn opt2_generated_test_case_048_ok() {
...
#[test]
fn opt2_generated_test_case_048_fail() {
...
#[test]
fn opt2_generated_test_case_049_ok() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_049_fail() {
    let user_attrs = vec![];
    let policy = "((!D.b:0 & (C.b:3 | (!A.e:6 | D.b:5))) | D.e:0)";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_050_ok() {
...
#[test]
fn opt2_generated_test_case_050_fail() {
...
#[test]
fn opt2_generated_test_case_051_ok() {
...
#[test]
fn opt2_generated_test_case_051_fail() {
...
#[test]
fn opt2_generated_test_case_052_ok() {
...
#[test]
fn opt2_generated_test_case_052_fail() {
    let user_attrs = vec![];
    let policy = "D.b:2";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_053_ok() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_053_fail() {
...
#[test]
fn opt2_generated_test_case_054_ok() {
...
#[test]
fn opt2_generated_test_case_054_fail() {
...
#[test]
fn opt2_generated_test_case_055_ok() {
...
#[test]
fn opt2_generated_test_case_055_fail() {
    let user_attrs = vec!["C.e:6"];
    let policy = "((B.c:0 & C.e:6) | (B.c:3 | C.a:2))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_056_ok() {
...
#[test]
fn opt2_generated_test_case_056_fail() {
...
#[test]
fn opt2_generated_test_case_057_ok() {
...
#[test]
fn opt2_generated_test_case_057_fail() {
...
#[test]
fn opt2_generated_test_case_058_ok() {
...
#[test]
fn opt2_generated_test_case_058_fail() {
...
#[test]
fn opt2_generated_test_case_059_ok() {
...
#[test]
fn opt2_generated_test_case_059_fail() {
    let user_attrs = vec![];
    let policy = "A.e:4";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_060_ok() {
...
#[test]
fn opt2_generated_test_case_060_fail() {
...
#[test]
fn opt2_generated_test_case_061_ok() {
...
#[test]
fn opt2_generated_test_case_061_fail() {
    let user_attrs = vec![];
    let policy = "D.d:5";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_062_ok() {
...
#[test]
fn opt2_generated_test_case_062_fail() {
    let user_attrs = vec![];
    let policy = "D.c:6";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_063_ok() {
...
#[test]
fn opt2_generated_test_case_063_fail() {
...
#[test]
fn opt2_generated_test_case_064_ok() {
...
#[test]
fn opt2_generated_test_case_064_fail() {
...
#[test]
fn opt2_generated_test_case_065_ok() {
...
#[test]
fn opt2_generated_test_case_065_fail() {
...
#[test]
fn opt2_generated_test_case_066_ok() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_066_fail() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_067_ok() {
...
#[test]
fn opt2_generated_test_case_067_fail() {
...
#[test]
fn opt2_generated_test_case_068_ok() {
...
#[test]
fn opt2_generated_test_case_068_fail() {
    let user_attrs = vec![];
    let policy = "(!A.b:4 | C.a:4)";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_069_ok() {
...
#[test]
fn opt2_generated_test_case_069_fail() {
    let user_attrs = vec![];
    let policy = "B.c:1";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_070_ok() {
...
#[test]
fn opt2_generated_test_case_070_fail() {
...
#[test]
fn opt2_generated_test_case_071_ok() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_071_fail() {
...
#[test]
fn opt2_generated_test_case_072_ok() {
...
#[test]
fn opt2_generated_test_case_072_fail() {
...
#[test]
fn opt2_generated_test_case_073_ok() {
...
#[test]
fn opt2_generated_test_case_073_fail() {
    let user_attrs = vec![];
    let policy = "A.c:3";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_074_ok() {
...
#[test]
fn opt2_generated_test_case_074_fail() {
    let user_attrs = vec![];
    let policy = "(((D.d:6 & ((D.c:1 | B.c:1) | C.d:0)) & C.b:1) | (C.c:4 | A.c:3))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_075_ok() {
...
#[test]
fn opt2_generated_test_case_075_fail() {
    let user_attrs = vec![];
    let policy = "(B.c:6 | !A.e:0)";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_076_ok() {
...
#[test]
fn opt2_generated_test_case_076_fail() {
...
#[test]
fn opt2_generated_test_case_077_ok() {
...
#[test]
fn opt2_generated_test_case_077_fail() {
    let user_attrs = vec![];
    let policy = "(D.c:0 | (B.a:0 & (C.a:5 & ((!B.d:6 | !A.c:1) | !D.d:2))))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_078_ok() {
...
#[test]
fn opt2_generated_test_case_078_fail() {
    let user_attrs = vec![];
    let policy = "((B.a:6 | (!D.c:4 | A.d:6)) | !B.b:6)";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_079_ok() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_079_fail() {
...
#[test]
fn opt2_generated_test_case_080_ok() {
...
#[test]
fn opt2_generated_test_case_080_fail() {
...
#[test]
fn opt2_generated_test_case_081_ok() {
...
#[test]
fn opt2_generated_test_case_081_fail() {
    let user_attrs = vec![];
    let policy = "(!A.a:2 | (((!D.d:4 | (C.b:3 | (D.e:1 | B.a:2))) & C.a:4) | D.d:4))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_082_ok() {
...
#[test]
fn opt2_generated_test_case_082_fail() {
...
#[test]
fn opt2_generated_test_case_083_ok() {
...
#[test]
fn opt2_generated_test_case_083_fail() {
    let user_attrs = vec![];
    let policy = "D.b:3";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_084_ok() {
...
#[test]
fn opt2_generated_test_case_084_fail() {
    let user_attrs = vec![];
    let policy = "A.b:4";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_085_ok() {
...
#[test]
fn opt2_generated_test_case_085_fail() {
...
#[test]
fn opt2_generated_test_case_086_ok() {
...
#[test]
fn opt2_generated_test_case_086_fail() {
    let user_attrs = vec![];
    let policy = "!B.e:5";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_087_ok() {
...
#[test]
fn opt2_generated_test_case_087_fail() {
    let user_attrs = vec![];
    let policy = "D.e:5";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_088_ok() {
    let user_attrs = vec!["D.e:1"];
    let policy = "D.e:1";
    assert_decryption_ok(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_088_fail() {
    let user_attrs = vec![];
    let policy = "D.e:1";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_089_ok() {
...
#[test]
fn opt2_generated_test_case_089_fail() {
...
#[test]
fn opt2_generated_test_case_090_ok() {
...
#[test]
fn opt2_generated_test_case_090_fail() {
    let user_attrs = vec![];
    let policy = "A.c:4";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_091_ok() {
...
#[test]
fn opt2_generated_test_case_091_fail() {
...
#[test]
fn opt2_generated_test_case_092_ok() {
...
#[test]
fn opt2_generated_test_case_092_fail() {
    let user_attrs = vec![];
    let policy = "((C.b:4 | C.a:1) | C.c:3)";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_093_ok() {
    let user_attrs = vec!["A.e:3"];
    let policy = "A.e:3";
    assert_decryption_ok(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_093_fail() {
    let user_attrs = vec![];
    let policy = "A.e:3";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_094_ok() {
...
#[test]
fn opt2_generated_test_case_094_fail() {
...
#[test]
fn opt2_generated_test_case_095_ok() {
...
#[test]
fn opt2_generated_test_case_095_fail() {
    let user_attrs = vec![];
    let policy = "((!B.e:1 | ((!A.b:2 | (D.b:0 | (A.e:4 & A.c:3))) | D.e:5)) | (A.d:3 | B.d:4))";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_096_ok() {
    let user_attrs = vec!["D.c:1"];
    let policy = "D.c:1";
    assert_decryption_ok(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_096_fail() {
    let user_attrs = vec![];
    let policy = "D.c:1";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_097_ok() {
...
#[test]
fn opt2_generated_test_case_097_fail() {
...
#[test]
fn opt2_generated_test_case_098_ok() {
...
#[test]
fn opt2_generated_test_case_098_fail() {
    let user_attrs = vec![];
    let policy = "B.a:1";
    assert_decryption_fail(user_attrs, policy);
}
...
#[test]
fn opt2_generated_test_case_099_ok() {
    let user_attrs = vec![
...
#[test]
fn opt2_generated_test_case_099_fail() {
