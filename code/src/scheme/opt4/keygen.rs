...
type MSK = <super::Opt4 as Scheme>::MSK;
type PartialMSK = <super::Opt4 as Scheme>::PartialMSK;
type USK = <super::Opt4 as Scheme>::USK;
type PartialUSK = <super::Opt4 as Scheme>::PartialUSK;
use crate::hashing::{
